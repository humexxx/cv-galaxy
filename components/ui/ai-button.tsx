/**
 * AI Button Component with Particle Effects
 * 
 * Setup Instructions:
 * 
 * 1. Install required packages with exact versions:
 *    npm install --save-exact tsparticles @tsparticles/react @tsparticles/engine
 * 
 * 2. Add sparkle animation to globals.css inside @theme inline block:
 *    @keyframes sparkle {
 ...
 * 
 * 3. Use the animate-[sparkle] or animate-sparkle class in your components
 */
'use client';
...
export default function AiButton({ 
  ...
  const modifiedOptions = useMemo(() => {
    return {
      ...options,
      emitters: Array.isArray(options.emitters) 
